                                    ...
                                    <div class="col-xl-5 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                @endphp
                                                <input type="number" step="any" class="form-control" name="rate" value="{{$price_ft->price_ft}}" disabled/>
                                                <span class="currency_symbol input-group-text"></span>
                                            </div>
                                            <p class="text-muted">@lang('Change Rate from General Settings FT Price')</p>
                                        </div>
                                    </div>
                                </div>
