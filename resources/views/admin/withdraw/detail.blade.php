...
@section('panel')
    <div class="row mb-none-30">
        ...
        {{-- @dd($withdrawal) --}}
        @if( $withdrawal->withdraw_type == "metamask")
        <div class="col-lg-4 col-md-4 mb-30">
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    <h5 class="mb-20 text-muted">@lang('Withdraw Via') {{__(@$withdrawal->withdraw_type)}}</h5>
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Method')
                            <span class="fw-bold">{{__($withdrawal->withdraw_type)}}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Amount')
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Payable')
                            <span class="fw-bold">{{ showAmount($withdrawal->amount) }} {{__($withdrawal->currency)}}</span>
                        </li>
        ...
        <div class="col-lg-8 col-md-8 mb-30">
            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    {{-- @dd($withdrawal->withdraw_type) --}}
                    @php
                        $meta = json_decode($withdrawal->metamask_info);
                    @endphp
                    ...
                    <ul class="caption-list">
                        <li>
                            ...
                            <span class="value">{{ $meta->from }}</span>
                        </li>
                        <li>
                            <span class="caption">@lang('Transection Hash: ')</span>
                            <span class="value">{{ $meta->transactionHash }}</span>
                        </li>
                        <li>
                            <span class="caption">@lang('Rate: ')</span>
                            <span class="value">{{ showAmount($withdrawal->rate) }} {{ __($general->cur_text) }}</span>
                        </li>
                        <li>
                            <span class="caption">@lang('Conversion: ')</span>
                            <span class="value">{{ $general->cur_sym }}{{ showAmount($withdrawal->amount - $withdrawal->charge) }} x {{ $general->cur_sym }}{{ showAmount($withdrawal->rate) }} = {{ $general->cur_sym }}{{ showAmount($withdrawal->amount) }}</span>
                        </li>
                        <li>
                            <span class="caption">@lang('In FT: ')</span>
                            <span class="value">{{ showAmount($withdrawal->amount) }} FT</span>
                        </li>
                    </ul>
                    @endif
                    ...
                    @if($withdrawal->status == 2 && auth('admin')->user()->role_status == 0)
                        <div class="row mt-4">
                            <div class="col-md-12">
