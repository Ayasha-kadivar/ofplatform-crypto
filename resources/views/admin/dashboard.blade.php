            ...
            <div class="widget-two box--shadow2 b-radius--5 bg--white">
                ...
                <div class="widget-two__icon b-radius--5 bg--success">
                    <i class="fas fa-hand-holding-usd"></i>
                        ...
                        @php
                        // $sum = \App\Models\User::sum('pool_4','interest_wallet');
                        // $sum = \App\Models\User::select('pool_4', 'interest_wallet')->sum('pool_4', 'interest_wallet');
                        $sum = \App\Models\User::selectRaw('SUM(pool_2+pool_3+pool_4 + interest_wallet) as total_sum')->pluck('total_sum')->first();


                        @endphp
                <div class="widget-two__content">
                    <h3>{{ $general->cur_sym }}{{ $sum }}</h3>
                    <p>@lang('Total in Pools')</p>
                </div>
