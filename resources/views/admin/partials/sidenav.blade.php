    ...
    <div class="sidebar__inner">
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                @if (auth('admin')->check() && auth('admin')->user()->role_status == 1)
                ...
                {{-- <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.users*',3)}}">
                        ...
                        <span class="menu-title">@lang('KYC')</span>
                    </a>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.users*',3)}}">
                        ...
                        @if($deactivatedUsersCount > 0 || $bannedUsersCount > 0 || $emailUnverifiedUsersCount > 0 || $mobileUnverifiedUsersCount > 0
                    ...
                    <div class="sidebar-submenu {{menuActive('admin.users*',2)}} ">
                        <ul>
                            @php
                            $count_activeuser = \App\Models\User::active()->count();
                            @endphp
                            <li class="sidebar-menu-item {{menuActive('admin.users.active')}} ">
                                <a href="{{route('admin.users.active')}}" class="nav-link">
                                    ...
                                    @if($count_activeuser)
                                    <span class="menu-badge pill bg--danger ms-auto">{{$count_activeuser}}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.users.deactivated')}} ">
                                <a href="{{route('admin.users.deactivated')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Deactivated users')</span>
                                    @if($deactivatedUsersCount)
                                    <span class="menu-badge pill bg--danger ms-auto">{{$deactivatedUsersCount}}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            @php
                            $count_unverifiedfee = \App\Models\User::where('fee_status', 0)->count();
                            @endphp
                            <li class="sidebar-menu-item {{menuActive('admin.users.all')}} ">
                                <a href="{{route('admin.users.fee-unverified')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Fee Unverified')</span>
                                    @if($count_unverifiedfee)
                                    <span class="menu-badge pill bg--danger ms-auto">{{$count_unverifiedfee}}</span>
                                    @endif
                                </a>
                            </li>
                            @php
                            $count_pendingfee = \App\Models\User::where('fee_status', 1)->count();
                            @endphp
                            <li class="sidebar-menu-item {{menuActive('admin.users.all')}} ">
                                <a href="{{route('admin.users.maintenence-fee')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Fee Pending')</span>
                                    @if($count_pendingfee)
                                    <span class="menu-badge pill bg--danger ms-auto">{{$count_pendingfee}}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            @php
                            $count_pendingvip = \App\Models\RequestPayment::where('trx_type','vip_membership')->where('status',0)->count();
                            @endphp
                            <li class="sidebar-menu-item {{menuActive('admin.users.all')}} ">
                                <a href="{{route('admin.users.vip-pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('VIP Pending')</span>
                                    @if($count_pendingvip)
                                    <span class="menu-badge pill bg--danger ms-auto">{{$count_pendingvip}}</span>
                                    @endif
                                </a>
                            </li>

                            @php
                            $count_allusers = \App\Models\User::count();
                            @endphp
                            <li class="sidebar-menu-item {{menuActive('admin.users.all')}} ">
                                <a href="{{route('admin.users.all')}}" class="nav-link">
                                    ...
                                    @if($count_allusers)
                                    <span class="menu-badge pill bg--danger ms-auto">{{$count_allusers}}</span>
                                    @endif
                                </a>
                            </li>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.cubeonetowithdraw*',3)}}">
                        <i class="menu-icon la la-bank"></i>
                        <span class="menu-title">@lang('Cube One to Wallet Withdrawals') </span>
                        @if(0 < $pendingCubeOneToWalletWithdrawCount) <span class="menu-badge pill bg--danger ms-auto">
                            <i class="fa fa-exclamation"></i>
                            </span>
                            @endif
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.cubeonetowithdraw*',2)}} ">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.cubeonetowithdraw.pending')}} ">
                                <a href="{{route('admin.cubeonetowithdraw.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Pending Withdrawals')</span>
                                    @if($pendingCubeOneToWalletWithdrawCount)
                                    <span class="menu-badge pill bg--danger ms-auto">{{$pendingCubeOneToWalletWithdrawCount}}</span>
                                    @endif
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.cubeonetowithdraw.approved')}} ">
                                <a href="{{route('admin.cubeonetowithdraw.approved')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved Withdrawals')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.cubeonetowithdraw.rejected')}} ">
                                <a href="{{route('admin.cubeonetowithdraw.rejected')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                        ...
                        <ul>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.users.kyc.verified')}}">
                                <a href="{{route('admin.users.kyc.verified')}}" class="nav-link">
                                    ...
                                    @if($kycVerifiedUsersCount)
                                    <span class="menu-badge pill bg--danger ms-auto">{{$kycVerifiedUsersCount}}</span>
                                    @endif
                                </a>
                            </li>
                            ...
                            @php
                            $count_withbalance = \App\Models\User::where(function($query) {
                            $query->where('deposit_wallet', '<>', 0)
                                ->orWhere('interest_wallet', '<>', 0);
                                    ...
                                    <li class="sidebar-menu-item {{menuActive('admin.users.with.balance')}}">
                                        <a href="{{route('admin.users.with.balance')}}" class="nav-link">
                                            ...
                                            @if($count_withbalance)
                                            <span
                                                class="menu-badge pill bg--danger ms-auto">{{$count_withbalance}}</span>
                                            @endif
                                        </a>
                                    </li>
                                    ...
                                    {{--
                                    @php
                                    $count_newusers = \App\Models\User::whereNotNull('created_at')->count();
                                    @endphp
                                    <li class="sidebar-menu-item {{menuActive('admin.users.all')}} ">
                                        <a href="{{route('admin.users.usernew')}}" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">@lang('All New Users')</span>
                                            @if($count_newusers)
                                            <span class="menu-badge pill bg--danger ms-auto">{{$count_newusers}}</span>
                                            @endif
                                        </a>
                                    </li>
                                    @php
                                    $count_oldusers = \App\Models\User::whereNull('created_at')->count();
                                    @endphp
                                    <li class="sidebar-menu-item {{menuActive('admin.users.all')}} ">
                                        <a href="{{route('admin.users.userold')}}" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">@lang('All Old Users')</span>
                                            @if($count_oldusers)
                                            <span class="menu-badge pill bg--danger ms-auto">{{$count_oldusers}}</span>
                                            @endif
                                        </a>
                                    </li>

                                    <li class="sidebar-menu-item {{menuActive('admin.users.old.registrations')}} ">
                                        <a href="{{route('admin.users.old.registrations')}}" class="nav-link">
                                            <i class="menu-icon las la-dot-circle"></i>
                                            <span class="menu-title">@lang('All Old Registartions')</span>
                                        </a>
                                    </li>
                                    --}}
                ...
                <li class="sidebar-menu-item  {{menuActive('admin.hashid.*')}}">
                    <a href="{{route('admin.hashid.index')}}" class="nav-link"
                        data-default-url="{{ route('admin.hashid.index') }}">
                        <i class="menu-icon las la-id-card"></i>
                        <span class="menu-title">@lang('HASH ID') </span>
                    </a>
                </li>
