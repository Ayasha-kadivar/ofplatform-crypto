...
<div class="dashboard-inner">
    <div class="row justify-content-center">
        <div class="col-md-8 mb-5">
            ...
            @else
            <div class="card custom--card" id="manual" style="display: none;">
                <div class="card-body">
            ...
            <div class="card custom--card" id="metamask" style="">
                <div class="card-body">
    ...
    <script>
        (async function() {
          ...
          const contractWithdraw = new _web3.eth.Contract(
            abi1, "0xd01877f14e3b74E2C10A208d433163E0dfC9F1E3"
          );
        ...
        .send({
            ...
            data: {
                "_token": "{{ csrf_token() }}",
                    ...
                    "user_id": {{ Auth::id() }},
                    "user_wallet_address": window.ethereum.selectedAddress,
                    "requested_with_draw_amount": amount,
