MinerNFT Game Rules (service agreement)


MinerNFT Game Rules<br>
•Members rent each MinerNFT at US$2000.<br>
•Each Member can rent a maximum of 50 MinerNFT during starting phase of the project.<br>
-Each MinerNFT rental is a 5 years contract.<br>
-Members can rent Fractions of MinerNFT for $20 each part<br>
•Each MinerNFT generates daily rewards of $10 into Rewards Cube. Rewards from MinerNFT starts only after Member has rented a full MinerNFT, Fractions do not generate any rewards.<br>
•Members can also use their Rewards Balance to rent additional parts of MinerNFTs once the balance surpasses US$20 in value, or buy the full MinerNFT from Rewards Balance or Deposit Wallet.<br>
•Members need to deposit Family Token (FT) in the integrated wallet at www.cryptofamilylove.co to activate the rental of MinerNFT.<br>

CryptoFamily and MinerNFT SERVICE AGREEMENT<br>

This CryptoFamily Service Agreement covers the acquisition of a MinerNFT and is entered between you (hereinafter referred to as “Customer”) and cryptofamilylove.co, Crypto Family FZC (hereinafter referred to as “Vendor”) that manages The MinerNFT.<br>
...
1.1.3 Through the acquisition of this full MinerNFT via the Customer’s computer or Internet compatible devices, the Customer shall be granted 10 $ a day rewards during 5 years. per MinerNFT. MinerNFT is non-transferable (other than as a result of the death of the Customer and any relevant will or probate processes in the Customer’s country).<br>
...
1.1.5 Customer acknowledges that if this present account in which Customer wishes to rent a MinerNFT is not Customer’s initial account, if Customer has rented a MinerNFT or any other product or service from his backoffice, such action is a violation of the Agreement and Customer is only entitled to receive the cost of the product or service.<br>

1.2 MinerNFT Rewards
1.2.1 Provided that Customer constantly complies with the express terms and conditions stated in this Agreement and CryptoFamily Terms and Conditions, Customer shall receive rewards (hereinafter known as “$”) from the Vendor on a daily basis during a 5 years contract duration for each MinerNFT.<br>
1.2.2 Each full MinerNFT entitles Customer to receive 10$ daily Rewards.<br>
1.2.3 Terms of MinerNFT are defined from the date of acquisition, and any subsequent MinerNFT is subject to subsequent terms at Vendor’s sole discretion.<br>
1.2.4 Customer understands that Vendor may alter or eliminate MinerNFT in the future at the Vendor’s total discretion.<br>
...
1.3.3 Vendor and Customer recognize that cryptocurrency tokens are subject to significant price fluctuations due to market unpredictability. Customer recognizes that token prices may rise or fall from time of redemption to the Customer's own exchange of that token on the Customer’s chosen external exchange.<br>
1.3.4 Crypto Family FZC does not bear any liability or responsibility for the price fluctuation of the released tokens.<br>
1.4 Optional Additional Services<br>
1.4.1 At the sole discretion of the Vendor, the Vendor may introduce to the Customer access to additional services beyond the MinerNFT rewards offered, including other products and services of Crypto Family FZC and Crypto Family FZC FZC other third-party platforms which may include discounted pricing, preferential rates, and any other product or service that Crypto Family FZC considers beneficial to its members.<br>
1.4.2 Customer understands and agrees that these optional services are not a part of the MinerNFT, other than CryptoFamily provides access to these other such optional services. These includes all products and services found in cube 4 and any other service, product or discount family members are entitled to or eligible for.<br>
...
2. MinerNFT Terms and Conditions<br>
2.1 Acquiring a MinerNFT<br>
2.1.1 Customer shall acquire cryptocurrency on their own exchange or wallet and transfer the FamilyToken (FT) to the Customer's own FT wallet address inside CryptoFamily back office as provided by the Vendor for the purpose of exchanging it for MinerNFT rewards.<br>
2.1.2 Vendor is not in the exchange or wallet business nor in the business of providing financial guidance or advice in any way, nor is Vendor in the business of providing specific training or support regarding specific exchanges or wallets the Customer may use to rent FT in their country.<br>
2.1.3 By renting the MinerNFT Customer confirms he has read and understood the Whitepaper and Game Rules, and accepts all conditions affecting his potential rewards.

2.2 Customer Services.<br>
2.2.1 Vendor shall make available directly or indirectly the education and instructional content for Customer to understand and execute operations as required to accomplish the Customer's aims from the MinerNFT.<br>
2.2.2 Vendor shall generate Rewards for the Customer in the amount of FT equivalent to 10$ per day per MinerNFT, during 5 years per MinerNFT. <br>

2.3 Limits of MinerNFT<br>
2.3.1 Customer understands that the FT exchanged for MinerNFT is the exclusive property of the Vendor, and Customer is only entitled to the MinerNFT and has no further entitlement to the original FamilyToken exchanged for it.<br>
2.3.2 Customer understands that sending of FT to Customer’s deposit address is solely for the purpose of MinerNFT acquisition, and does not entitle Customer to any actions except for the acquisition of MinerNFT. <br>
...
2.3.4 Customer bears all responsibility for sending the correct amount to result in the net deposit amount required to rent the desired MinerNFT package. Shortages must be made up with additional deposit(s).<br>

2.4 Vendor’s Best Efforts.<br>
2.4.1 The MinerNFT is on a best efforts basis and, like any project, there is a risk of loss of all funds and rewards.<br>
...
2.4.4 There is no recommendation by Vendor to rent any MinerNFT, product or service. Customers make their own decisions, based on Customer's own due diligence.<br>
...
2.5 Eligibility
2.5.1 By registering to use a CryptoFamily Account, and by acquiring the present MinerNFT, Customer represents and warrants:<br>
...
(iii) Customer takes responsibility and has determined that the acquisition of this MinerNFT is lawful in the country or territory in which the Customer resides, and holds Vendor harmless for its decision to rent this MinerNFT;<br>
(iv) Customer has not registered for more than one account, and Customer warrants that this present account is Customer’s initial and sole account; if this account in question is not the Customer’s initial account, it is not eligible for MinerNFT acquisition now or in the future;<br>
...
2.6.2 From time to time, Vendor may require further information and/or documentation to assist with this process.

2.7 Competition and Intellectual Property Rights
...
2.7.4 CryptoFamily and FamilyToken copyrights or trademarks used in this service, such as "MinerNFT" , are owned by Crypto Family FZC FZC.<br>
...
2.8.2 In the case of a legal entity MinerNFT, KYC will include the above, plus submission of proof of the person authorized to register and operate the account.<br>
2.8.3 Customer may be required to provide information related to the source of the FT used to rent the MinerNFT.<br>
...
2.9 Recourse
2.9.1 The acquisition of a MinerNFT from the Vendor shall be with full acknowledgement that Vendor’s activities are on a best-efforts basis and past performance is not a guarantee of future performance.<br>
2.9.2 Customer understands that Vendor’s blockchain activities include multiple sources of revenue, historically generating adequately to enable the Vendor to supply a range of MinerNFT rewards.<br>
2.9.3 In the event that such activities by the Vendor fail to produce the amount needed to fulfil the 10$ per day per MinerNFT Rewards expected by Customer, the Vendor will execute its best efforts to ensure MinerNFT Rewards expectations are met by liquidating digital portfolios of the Vendor as and when Vendor deems it necessary to meet such shortfall.<br>

2.10 Non-Refundable<br>
2.10.1 Customer understands that once FT has been sent to their Customer wallet address provided by Vendor, and exchanged for MinerNFT, no refund is possible.<br>
2.10.2 MinerNFT Rewards will be earned in accordance with this Agreement. Deposit by Customer of the FamilyToken to Customer’s wallet address provided by Vendor is acknowledgement of the irreversible nature of that exchange and cannot be reversed.
2.11 Violations / Account and CryptoFamily and MinerNFT Suspension and Termination<br>
2.11.1 Violations of this Agreement and/or CryptoFamily Terms and Conditions can result in the suspension or termination of Customer’s account, including this MinerNFT and any other products or services under this account, with the decision as to suspension or termination depending upon the gravity of the violation as determined by the Vendor.<br>
2.11.2 Accounts and MinerNFTs also will be suspended during the pendency of any reviews for KYC, AML/CTF, and reviews of multiple accounts and possible stacking by one customer. Serious violations of these areas or other applicable rules may result in termination of a CryptoFamily account and the MinerNFTs within that account.<br>
2.11.3 For the avoidance of doubt, if a customer, a CryptoFamily account or MinerNFT is suspended, it will mean that the Customer will not be able to withdraw or to rent new MinerNFTs or to make rebuys under the current CryptoFamily account.<br>
2.11.4 If an account is terminated (which would include all MinerNFTs within that account), it will mean that the Customer’s conduct has materially breached CryptoFamily Terms and Conditions and/or this Agreement. All unaccrued benefits of MinerNFT, including any remaining payment of MinerNFT rewards, will be forfeited by the Customer.<br>

3. Miscellaneous Provisions<br>
3.1 Notices.<br>
3.1.1 All Vendor notices or updates or requests pertinent to the terms of this Agreement, including any required revisions, and/or enforcement action will be given in writing and delivered to the Customer electronically via email address registered with Vendor or in the back office of the Vendor’s MinerNFT site, or both, at Vendor’s discretion.<br>
...
3.2 MinerNFT Management
3.2.1 After the Customer completes this MinerNFT acquisition process, Customer obtains the right to receive the rewards associated to the MinerNFT of cryptofamilylove.co. This right belongs to the initial applicant only. It is prohibited to give, borrow, rent, transfer or sell the account or this MinerNFT with the account (other than as a result of the death of the customer and any relevant will or probate processes in the Customer’s country).  <br>
...
3.2.3 Customer shall abide by the terms of this Agreement and use the MinerNFT correctly and appropriately. If Customer violates any of the terms of this Agreement or CryptoFamily Terms and Conditions, CryptoFamily has the right to terminate the services provided to the CryptoFamily account and MinerNFTs owned by but not belonged to the Customer.<br>

3.9 Agreement and Meaning
3.9.1 This MinerNFT Acquisition Agreement, including CryptoFamily Terms and Conditions, also referred to as “Agreement” comprise the entire agreement between the parties.<br>
...
3.9.6 By using cryptofamilylove.co services, you are deemed to have read, and have agreed to be bound by this Agreement and MinerNFT Terms and Conditions.<br>
