...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        \App\Http\Middleware\EnsureResponseHasCacheControlHeader::class,
        \App\Http\Middleware\StrictTransportSecurityMiddleware::class,
        \App\Http\Middleware\CacheControlMiddleware::class,
        \App\Http\Middleware\SanitizeUrlMiddleware::class,
    ...
    protected $routeMiddleware = [
        ...
        'Kycsubmit.Middleware' => \App\Http\Middleware\KycsubmitMiddleware::class,
        'verify.redirects' => \App\Http\Middleware\VerifyRedirects::class,
      'xss' => \App\Http\Middleware\XssSanitization::class,
      'html_purifier' => \App\Http\Middleware\HtmlPurifierMiddleware::class,
      'xframe' => \App\Http\Middleware\SetXFrameOptions::class,
