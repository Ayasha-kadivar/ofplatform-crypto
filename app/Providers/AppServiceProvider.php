    ...
    \Illuminate\Support\Facades\URL::forceScheme('https');
        ...
        view()->composer('admin.partials.sidenav', function ($view) {
            $view->with([
                ...
                'deactivatedUsersCount'      => User::deactivated()->count(),
                'emailUnverifiedUsersCount'  => User::emailUnverified()->count(),
                'mobileUnverifiedUsersCount' => User::mobileUnverified()->count(),
                'kycUnverifiedUsersCount'    => User::kycUnverified()->count(),
                'kycVerifiedUsersCount'    => User::kycVerified()->count(),
                'kycPendingUsersCount'       => User::kycPending()->count(),
                'pendingTicketCount'         => SupportTicket::whereIN('status', [0, 2])->count(),
                'pendingDepositsCount'       => Deposit::pending()->count(),
                'pendingWithdrawCount'       => Withdrawal::pending()->count(),
                'pendingCubeOneToWalletWithdrawCount'    => WithdrawalsRequestCubeOneToWallet::pending()->count(),
            ]);
        });
